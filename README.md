...
8. STO	mem[address] = A
9. LD	A= mem[address]
10. JMP	PC= address always
11. JZ      PC= address if zero
12. JNE	PC= address if negative
13. JC	PC= address if carry
14. JV	PC= address if overflow
15. SHO	Display the A register
16. HLT	Halt CPU
